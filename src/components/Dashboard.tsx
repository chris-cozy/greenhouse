...
import { BookOpenText, Camera, Check, Plus, Sprout } from "lucide-react";
...
function Reminder({item,onDismissed}:{item:DashboardData["upcomingReminders"][number];onDismissed:()=>void}){
