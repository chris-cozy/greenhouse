...
const care = [
  [ids.plant.milo, "demo-care-milo-water", { activityType: "watering", guidance: "Water deeply when the upper few inches feel dry.", cadenceDays: 10, reminderEnabled: true, reminderRepeat: true, reminderCadenceDays: 10, nextReminderDate: "2026-08-28", notes: "Empty the cachepot after drainage; the moss pole can take a separate small pour.", sortOrder: 0 }],
  ...
  [ids.plant.opal, "demo-care-opal-water", { activityType: "watering", guidance: "Keep the mix evenly moist with filtered water.", cadenceDays: 6, reminderEnabled: true, reminderRepeat: true, reminderCadenceDays: 6, nextReminderDate: "2026-08-24", notes: "Check the center of the pot, not only the edges.", sortOrder: 0 }],
  ...
  [ids.plant.etta, "demo-care-etta-water", { activityType: "watering", guidance: "Let the pot become light, then soak and drain completely.", cadenceDays: 12, reminderEnabled: true, reminderRepeat: true, reminderCadenceDays: 12, nextReminderDate: "2026-09-01", notes: "Tubers hold more water than the fine vines suggest.", sortOrder: 0 }],
  [ids.plant.june, "demo-care-june-roots", { activityType: "watering", guidance: "Water when visible roots turn from green to silvery.", cadenceDays: 8, reminderEnabled: true, reminderRepeat: true, reminderCadenceDays: 8, nextReminderDate: "2026-08-25", notes: "Use lukewarm water and keep the crown dry overnight.", sortOrder: 0 }],
